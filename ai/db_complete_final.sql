--
-- PostgreSQL database dump - COMPLETE VERSION (CORRECTED)
-- Bao gồm tất cả 24 bảng cũ + 3 bảng mới = 27 bảng tổng cộng
-- Đã sửa lỗi trùng lặp và thiếu bảng
--
...
-- =====================================================
-- 24 BẢNG CŨ (từ db.sql gốc)
-- =====================================================

-- 1. Audit Logs (với cột mới cho ABAC)
...
-- 7. Documents (với cột mới cho ABAC)
...
-- Existing foreign keys from original schema
...
-- New foreign keys for ABAC tables and columns
...
-- =====================================================
-- SUMMARY: 27 TABLES TOTAL
-- =====================================================
-- 24 bảng cũ từ db.sql gốc + 3 bảng mới cho ABAC = 27 bảng
-- Đã sửa lỗi trùng lặp và thiếu bảng từ file db_complete.sql trước đó
